...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin.php">
                ...
                <div class="sidebar-brand-text mx-3">SPP | SMKN 1 KEPANJEN</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="admin.php">
                    <i class="fas fa-fw fa-tachometer-alt bg-primary"></i>
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="jurusan.php">Jurusan</a>
                        ...
                        <hr>
                        <a class="collapse-item" href="cards.html">Jenis Bayar</a>
                        <a class="collapse-item" href="cards.html">User</a>
                        <hr>
                        <a class="collapse-item" href="cards.html">Tahun Pelajaran</a>
        </div>
    </div>
</li>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Aplikasi Pembayaran SPP </span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
